...
public class CollectorVictoryFlameEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public static Color characterColors =  Color.CHARTREUSE.cpy();

    public CollectorVictoryFlameEffect() {
        this.duration = 1.0F;
