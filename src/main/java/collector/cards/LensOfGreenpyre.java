...
public class LensOfGreenpyre extends AbstractCollectorCard {
    public final static String ID = makeID(LensOfGreenpyre.class.getSimpleName());
    // intellij stuff skill, self, uncommon, , , , , 1, 1

    public LensOfGreenpyre() {
