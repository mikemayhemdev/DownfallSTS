...
public class GoldenIdol_Evil extends AbstractImageEvent {
    public static final String ID = "downfall:GoldenIdol";
    ...
    public static void save() {
        if (AbstractDungeon.player != null && downfallMod.bruhData != null) {
            try {
                downfallMod.bruhData.setBool("trapEvent", trapAlreadySet);
                downfallMod.bruhData.save();
    ...
    public static void load() {
        if (downfallMod.bruhData != null && downfallMod.bruhData.has("trapEvent")) {
            trapAlreadySet = downfallMod.bruhData.getBool("trapEvent");
        }
    }
