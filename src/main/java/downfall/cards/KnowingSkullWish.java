...
public class KnowingSkullWish extends AbstractDownfallCard implements OctopusCard {
    ...
    public ArrayList<OctoChoiceCard> choiceList() {
        ...
        if (!upgraded) {
            goldCard = new OctoChoiceCard("ks:0", NAMES[0], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[0]);
            colorlessCard = new OctoChoiceCard("ks:1", NAMES[1], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[1]);
            potionCard = new OctoChoiceCard("ks:2", NAMES[2], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[2]);
        } else {
            goldCard = new OctoChoiceCard("ks:0", NAMES[0], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[24]);
            colorlessCard = new OctoChoiceCard("ks:1", NAMES[1], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[25]);
            potionCard = new OctoChoiceCard("ks:2", NAMES[2], downfallMod.makeCardPath("KnowingSkullWish.png"), TEXT[26]);
            goldCard.upgrade();
