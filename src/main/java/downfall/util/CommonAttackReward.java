...
public class CommonAttackReward extends CustomReward {
    public static final String ID = downfallMod.makeID("CommonAttackReward");
    public static final String[] TEXT = CardCrawlGame.languagePack.getUIString(ID).TEXT;

    public CommonAttackReward() {
        super(TextureLoader.getTexture("downfallResources/images/rewards/upgrade_card_reward.png"), TEXT[0], RewardItemTypeEnumPatch.UPGRADECARD);
    }
