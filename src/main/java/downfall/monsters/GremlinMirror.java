...
public class GremlinMirror extends AbstractMonster {
    ...
    public GremlinMirror() {
        super(NAME, "GremlinMirror", 158, 0.0F, -15.0F, 200.0F, 310.0F, null, 35.0F, 0.0F);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 4:
                ...
                AbstractDungeon.actionManager.addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(0), AbstractGameAction.AttackEffect.SLASH_VERTICAL, true));
