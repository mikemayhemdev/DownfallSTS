...
public class Hexed extends AbstractDailyMod {
    public static final String ID = downfallMod.makeID("Hexed");
    ...
    public Hexed() {
        ...
        this.img = TextureLoader.getTexture("downfallResources/images/dailies/hexed.png");
    }
}
