...
public class Lament extends AbstractDailyMod {
    public static final String ID = downfallMod.makeID("Lament");
    ...
    public Lament() {
        ...
        this.img = TextureLoader.getTexture("downfallResources/images/dailies/Lament.png");
    }
}
