...
public class HexaghostTutorials extends FtueTip {
    ...
    public HexaghostTutorials() {
        ...
        this.img1 = TextureLoader.getTexture("hermitResources/images/tip/hexaghost_t1.png");
        this.img2 = TextureLoader.getTexture("hermitResources/images/tip/hexaghost_t2.png");
