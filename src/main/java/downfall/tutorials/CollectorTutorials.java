...
public class CollectorTutorials extends FtueTip {

    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString("HermitMod:CollectorTutorials");
    ...
    public CollectorTutorials() {
        ...
        this.img1 = TextureLoader.getTexture("hermitResources/images/tip/collector_t1.png");
        this.img2 = TextureLoader.getTexture("hermitResources/images/tip/collector_t2.png");
