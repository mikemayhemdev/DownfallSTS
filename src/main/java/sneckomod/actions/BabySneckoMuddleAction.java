...
public class BabySneckoMuddleAction extends AbstractGameAction {
        ...
        public void update () {
            ...
            for (AbstractCard card : AbstractDungeon.player.hand.group) {
                ...
                if ((card.costForTurn <= 0 || card.hasTag(SneckoMod.SNEKPROOF) || card.cost != card.costForTurn) && !card.freeToPlay() && !card.freeToPlayOnce && !(card.hasTag(expansionContentMod.ECHO))) {
