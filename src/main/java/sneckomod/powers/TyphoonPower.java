...
public class TyphoonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    //I'm finally biting the bullet and making this work because I'm not stupid anymore.
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (!isOverflowActive(card) || card.hasTag(NO_TYPHOON)) {
            ...
            for (int i = 0; i < this.amount; i++) {
                this.addToTop(new PlayTyphoonAction(AbstractDungeon.getCurrRoom().monsters.getRandomMonster((AbstractMonster) null, true, AbstractDungeon.cardRandomRng), true, false));
            }
    }
