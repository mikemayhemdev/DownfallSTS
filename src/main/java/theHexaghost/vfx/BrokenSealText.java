...
public class BrokenSealText extends AbstractGameEffect {
    public String msg;

    public BrokenSealText(Color col, String msg, float duration) {
    ...
    public void render(SpriteBatch sb) {
        if (!this.isDone) {
            ...
            FontHelper.renderFont(sb, FontHelper.SCP_cardEnergyFont, "THE SEALS ARE BROKEN!", (Settings.WIDTH / 2.0F) - baseBox / 2.0F, (Settings.HEIGHT - (180.0f * Settings.scale)) + layout.height / 2.0F, color);
