...
/*    */ public class SmokingEmberEffectGreen extends com.megacrit.cardcrawl.vfx.AbstractGameEffect
    ...
    public SmokingEmberEffectGreen(float x, float y) {
        ...
        this.y = y;
        /* 19 */
        this.vX = (com.badlogic.gdx.math.MathUtils.random(-600.0F, 600.0F) * com.megacrit.cardcrawl.core.Settings.scale);
        /* 20 */
        this.vY = (com.badlogic.gdx.math.MathUtils.random(-200.0F, 600.0F) * com.megacrit.cardcrawl.core.Settings.scale);
        /* 21 */
        this.gravity = (800.0F * com.megacrit.cardcrawl.core.Settings.scale);
        /*    */
        /* 23 */
        this.scale = (com.badlogic.gdx.math.MathUtils.random(0.2F, 0.4F) * com.megacrit.cardcrawl.core.Settings.scale);
        /* 24 */
        this.duration = com.badlogic.gdx.math.MathUtils.random(0.3F, 0.6F);
        /*    */
    }
    ...
    /*    */ {
        ...
        if (this.smokeTimer < 0.0F) {
            ...
            /* 36 */
            com.megacrit.cardcrawl.dungeons.AbstractDungeon.effectsQueue.add(new FastSmokeParticleGreen(this.x, this.y));
            /*    */
        }
        /*    */
        /* 39 */
