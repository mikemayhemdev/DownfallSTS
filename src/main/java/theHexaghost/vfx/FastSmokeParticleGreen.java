...
/*    */ public class FastSmokeParticleGreen extends AbstractGameEffect
    ...
    /*    */
    /* 18 */
    public FastSmokeParticleGreen(float x, float y) {
        if (img == null) {
            /* 19 */
            img = com.megacrit.cardcrawl.helpers.ImageMaster.EXHAUST_L;
            /*    */
        }
        /*    */
        /* 22 */
        this.targetScale = (MathUtils.random(0.3F, 0.6F) * com.megacrit.cardcrawl.core.Settings.scale);
        /* 23 */
        this.color = new Color(MathUtils.random(0.8F, 1.0F), 1.0F, MathUtils.random(0.5F, 0.8F), 1.0F);
        /*    */
        /* 25 */
    ...
    public void update() {
        ...
        if (this.color.b > 0.1F) {
            ...
            /* 34 */
            this.color.r -= Gdx.graphics.getDeltaTime() * 3.0F;
            /* 35 */
            this.color.g -= Gdx.graphics.getDeltaTime() * 0.5F;
            /* 36 */
        ...
        /*    */
        /* 51 */
        this.scale = com.badlogic.gdx.math.Interpolation.swingIn.apply(this.targetScale, 0.1F, this.duration / 0.6F);
        /* 52 */
