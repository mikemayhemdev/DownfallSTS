...
/*    */ public class ExplosionSmallEffectGreen extends com.megacrit.cardcrawl.vfx.AbstractGameEffect
    ...
    /*    */ {
        /* 22 */
        com.megacrit.cardcrawl.dungeons.AbstractDungeon.effectsQueue.add(new com.megacrit.cardcrawl.vfx.DarkSmokePuffEffect(this.x, this.y));
        /* 23 */
        for (int i = 0; i < 12; i++) {
            /* 24 */
            com.megacrit.cardcrawl.dungeons.AbstractDungeon.effectsQueue.add(new SmokingEmberEffectGreen(this.x +
                    /*    */
        ...
        /* 29 */
        com.megacrit.cardcrawl.core.CardCrawlGame.sound.playA("ATTACK_FIRE", MathUtils.random(-0.2F, -0.1F));
        /* 30 */
        this.isDone = true;
        /*    */
    }
