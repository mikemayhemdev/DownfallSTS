...
public class BackToBasicsTimeEater extends AbstractImageEvent {
    ...
    protected void buttonEffect(int buttonPressed) {
        switch (this.screen) {
            case INTRO:
                ...
                this.screen = BackToBasicsTimeEater.CUR_SCREEN.COMPLETE;
                break;
            case COMPLETE:
                this.openMap();
        }
