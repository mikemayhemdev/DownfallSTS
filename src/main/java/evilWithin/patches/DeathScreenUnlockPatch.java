...
import evilWithin.unlocks.GuardianUnlock;
import evilWithin.unlocks.HexaghostUnlock;
import evilWithin.unlocks.SneckoUnlock;
            ...
            if ((Settings.isDemo) || (Settings.isDailyRun)) {
                ...
                if ((AbstractDungeon.unlocks.isEmpty()) || (Settings.isDemo)) {
                    if ((Settings.isDemo) || (Settings.isDailyRun)) {
                        ...
                        return SpireReturn.Return(null);
                    } else if (!(UnlockTracker.isCharacterLocked("SlimeBoss")) &&
