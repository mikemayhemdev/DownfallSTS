...
public class LickTokenVuln extends AbstractSlimeboundCard {
    public static final String ID = "Slimebound:LickTokenVuln";
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/vulnlick.png";
    ...
    public LickTokenVuln() {
        ...
        SlimeboundMod.loadJokeCardImage(this, "vulnlick.png");
    }
