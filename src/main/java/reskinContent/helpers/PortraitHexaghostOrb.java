...
public class PortraitHexaghostOrb {
    private final BobEffect effect;
            ...
            if (this.activated) {
                ...
                if (this.activateTimer < 0.0F) {
                    ...
                    if (this.particleTimer < 0.0F) {
                        ...
                        this.particleTimer = 0.12F / (float) CharacterSelectScreenPatches.characters[2].skins[1].portraitAnimationType;
                    }
                }
            } else {
                this.effect.update();
