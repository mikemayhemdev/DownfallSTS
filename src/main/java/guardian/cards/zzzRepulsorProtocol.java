...
public class zzzRepulsorProtocol extends AbstractGuardianCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      //  if (GuardianMod.bronzeOrbInPlay == null){
           // AbstractDungeon.actionManager.addToBottom(new SpawnBronzeOrbAction(AbstractDungeon.player, SpawnBronzeOrbAction.powerTypes.DAMAGE, DAMAGE, 0, SpawnBronzeOrbAction.powerTypes.REPULSE, this.magicNumber, 0));
      //  } else {
        ...
        //    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(GuardianMod.bronzeOrbInPlay, p, new BronzeOrbWeakenPower(GuardianMod.bronzeOrbInPlay, this.magicNumber), this.magicNumber));

      //  }
    }

    public AbstractCard makeCopy() {
        return new zzzRepulsorProtocol();
    }
