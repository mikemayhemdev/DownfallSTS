...
public class PackageAutomaton extends AbstractGuardianCard {
    ...
    public AbstractGuardianCard constPrev1 = new HyperBeam_Guardian();
    public AbstractGuardianCard constPrev2 = new BronzeOrb();
    public AbstractGuardianCard constPrev3 = new BronzeArmor();
