...
public class PackageShapes extends AbstractGuardianCard {
    ...
    public AbstractGuardianCard constPrev1 = new TimeBomb();
    public AbstractGuardianCard constPrev2 = new SpikerProtocol();
    public AbstractGuardianCard constPrev3 = new Repulse();
    ...
    public PackageShapes() {
        ...
        GuardianMod.loadJokeCardImage(this, makeBetaCardPath("PackageShapes.png"));
    }
