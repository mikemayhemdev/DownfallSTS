...
public class PackageSentry extends AbstractGuardianCard {
    public static final String ID = GuardianMod.makeID("PackageSentry");
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/packageSentry.png";
    ...
    public AbstractGuardianCard constPrev1 = new SentryBeam();
    public AbstractGuardianCard constPrev2 = new SentryWave();
    public AbstractGuardianCard constPrev3 = new SentryWave();
    ...
    public PackageSentry() {
        ...
        GuardianMod.loadJokeCardImage(this, makeBetaCardPath("PackageSentry.png"));
    }
