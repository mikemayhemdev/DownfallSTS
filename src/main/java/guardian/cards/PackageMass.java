...
public class PackageMass extends AbstractGuardianCard {
    public static final String ID = GuardianMod.makeID("PackageMass");
    public static final String NAME;
    public static final String DESCRIPTION;
    public static final String IMG_PATH = "cards/packageMass.png";
    ...
    public AbstractGuardianCard constPrev1 = new MassSlam();
    public AbstractGuardianCard constPrev2 = new MassOfThorns();
    public AbstractGuardianCard constPrev3 = new MassTimeBomb();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
     ...
     //   tmp.modifyCostForCombat(-1);
        ...
        tmp = new MassOfThorns();
        if (upgraded) tmp.upgrade();
        derp.add(tmp);
     //   tmp.modifyCostForCombat(-1);

        tmp = new MassTimeBomb();
        if (upgraded) tmp.upgrade();
        derp.add(tmp);
      //  tmp.modifyCostForCombat(-1);
