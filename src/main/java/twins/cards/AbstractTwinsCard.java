...
import static twins.DonuDecaMod.getModID;
import static twins.DonuDecaMod.makeCardPath;

public abstract class AbstractTwinsCard extends CustomCard {
    ...
    public AbstractTwinsCard(final String id, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        super(id, "ERROR", getCorrectPlaceholderImage(type, id),
