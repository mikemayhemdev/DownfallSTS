...
public class FinalFeather extends CustomRelic implements OnAwakenRelic {
    ...
    private static final Texture IMG = TexLoader.getTexture(makeRelicPath("awakenedCore.png")); //TODO: Images
    private static final Texture OUTLINE = TexLoader.getTexture(makeRelicOutlinePath("awakenedCore.png"));
