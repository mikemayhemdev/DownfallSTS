...
public class Control extends AbstractChampCard implements OctopusCard {
    ...
    public ArrayList<OctoChoiceCard> choiceList() {
        ...
        cardList.add(new OctoChoiceCard("octo:OctoBerserk", this.name, HexaMod.makeCardPath("Float.png"), upgraded ? this.EXTENDED_DESCRIPTION[3] : this.EXTENDED_DESCRIPTION[1]));
        return cardList;
    }
