...
public class BigShotPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = HermitMod.makeID(BigShotPower.class.getSimpleName());
    ...
    public BigShotPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new BigShotPower(owner, amount);
    }
}
