...
public class AddCopyPower extends AbstractPower implements NonStackablePower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(expansionContentMod.getModID() + "Resources/images/powers/PolyBeam84.png");
    private static final Texture tex32 = TextureLoader.getTexture(expansionContentMod.getModID() + "Resources/images/powers/PolyBeam32.png");
