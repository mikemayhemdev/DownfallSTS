...
public class ArchetypeIcStrike extends ArchetypeBaseIronclad {
    ...
    public void initialize() {
        ...
        this.addCardToList(new EnTwinStrike(), CardBenefitType.SIGNATUREACT1);
        this.addCardToList(new EnWildStrike(), CardBenefitType.SIGNATUREACT2);
        this.addCardToList(new EnPerfectedStrike(), CardBenefitType.SIGNATUREACT3);
        ...
        this.addCardToList(new EnArmaments(), CardBenefitType.SUPPORTING);
