...
public class EnHeadshot extends AbstractBossCard {
    ...
    public EnHeadshot() {
        super(ID, cardStrings.DESCRIPTION, "green/attack/strike", 1, cardStrings.DESCRIPTION, CardType.ATTACK, hermit.Enums.COLOR_YELLOW, CardRarity.BASIC, CardTarget.ENEMY, AbstractMonster.Intent.ATTACK);
        this.baseDamage = 8;
    }
