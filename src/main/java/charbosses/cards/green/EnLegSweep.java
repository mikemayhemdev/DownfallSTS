...
public class EnLegSweep extends AbstractBossCard {
    ...
    public EnLegSweep() {
        super(ID, EnLegSweep.cardStrings.NAME, "green/attack/leg_sweep", 2, EnLegSweep.cardStrings.DESCRIPTION, CardType.SKILL, CardColor.GREEN, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseBlock = 11;
