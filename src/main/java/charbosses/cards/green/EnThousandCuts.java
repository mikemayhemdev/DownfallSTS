...
public class EnThousandCuts extends AbstractBossCard {
    ...
    public EnThousandCuts() {
        super(ID, EnThousandCuts.cardStrings.NAME, "green/attack/leg_sweep", 2, EnThousandCuts.cardStrings.DESCRIPTION, CardType.POWER, CardColor.GREEN, CardRarity.RARE, CardTarget.ENEMY);
