...
public class EnBlur extends AbstractBossCard {
    ...
    public EnBlur() {
        super(ID, EnBlur.cardStrings.NAME, "green/attack/blur", 1, EnBlur.cardStrings.DESCRIPTION, CardType.SKILL, CardColor.GREEN, CardRarity.UNCOMMON, CardTarget.SELF);
        this.baseBlock = 5;
    }
