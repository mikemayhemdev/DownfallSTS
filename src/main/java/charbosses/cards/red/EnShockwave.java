...
public class EnShockwave extends AbstractBossCard {
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, m, new WeakPower(p, this.magicNumber, true), this.magicNumber + 1, true, AbstractGameAction.AttackEffect.NONE));
        this.addToBot(new ApplyPowerAction(p, m, new VulnerablePower(p, this.magicNumber, true), this.magicNumber + 1, true, AbstractGameAction.AttackEffect.NONE));
    }
