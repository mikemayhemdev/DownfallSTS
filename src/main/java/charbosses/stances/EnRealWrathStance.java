...
public class EnRealWrathStance extends AbstractEnemyStance {
    ...
    public float atDamageGive(float damage, DamageType type) {
        return type == DamageType.NORMAL ? damage * 2F : damage;
    }

    public float atDamageReceive(float damage, DamageType type) { // TODO: Doesn't work
        return type == DamageType.NORMAL ? damage * 2F : damage;
    }
