...
public class EnemyShadowCloakPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = ShadowCloakPower.POWER_ID;
    ...
    public EnemyShadowCloakPower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new EnemyShadowCloakPower(owner, amount);
    }
}
